...
('1k23456', 'Ποδόσφαιρο', 'Δωροθέα Αγαθή',0, 500),
('1234568', 'Μπάσκετ', 'Ιωάννης Κάπης', 3, 1100),
('e3o3pk3', 'Μπάσκετ', 'Μαριάνθη Μελεμενή', 3, 1100),
('1234569', 'Τέννις', 'Χρήστος Δημητριάδης', 1, 900),
('1235469', 'Βόλευ', 'Εμανουήλ Εμανουηλίδης', 2, 800),
('2k39p87', 'Κολύμβηση', 'Ισίδορος Παναγιώτου', 5, 1200); 
...
(123460, 'Ελένη Παπαδοπούλου', 'Γυναίκα', '2021-09-13', '2003-01-20', 'e3o3pk3', 'Μπάσκετ'),
...
(195842, 'Φριδερίκη Παπαδοφασομανολάκη','Γυναίκα','2021-10-03','2008-11-13','2k39p87','Κολύμβηση'),
(123462, 'Ιωάννης Γερασιμόπουλος', 'Άνδρας', '2022-10-20', '2002-02-25', '1234567', 'Ποδόσφαιρο'),
(123463, 'Μαρία Κουτούκου', 'Γυναίκα', '2022-09-05', '2003-03-10', '1k23456', 'Ποδόσφαιρο'),
(123464, 'Νικόλαος Παπαδόπουλος', 'Άνδρας', '2022-09-10', '2001-08-15', '1234568', 'Μπάσκετ'),
(123465, 'Ειρήνη Γεωργίου', 'Γυναίκα', '2022-08-25', '2002-05-20', 'e3o3pk3', 'Μπάσκετ'),
...
(195843, 'Σίσιφος Ποσειδώνας Σμιθ', 'Άνδρας', '2023-01-10', '2009-02-18', '2k39p87', 'Κολύμβηση'),
(195844, 'Ελένη Μίτσου', 'Γυναίκα', '2023-02-15', '2007-07-23', '2k39p87', 'Κολύμβηση');
...
(3479, 'Μπάσκετ','Εαρινό', 2022, '2022-05-02', '17:00:00', 'ήττα', 'φιλικό', 'έδρα'),
...
(3483, 'Ποδόσφαιρο','Εαρινό', 2022, '2022-06-06', '14:00:00', 'ήττα', 'φιλικό', 'έδρα'),
